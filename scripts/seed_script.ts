...
const LEARNING_PATHS_DATA = [
  ...
  },
  {
    ...
    modules: [
      {
        id: 'm1',
        title: 'Intro to Herbalism',
        lessons: [
          { id: 'l1', title: 'History of Herbal Medicine', duration: '6 min', type: 'article', isCompleted: false },
          { id: 'l2', title: 'Basic Equipment for Home Remedies', duration: '8 min', type: 'video', isCompleted: false },
        ]
      },
      {
        id: 'm2',
        title: 'Common Herbs',
        lessons: [
          { id: 'l3', title: 'Lavender for Stress Relief', duration: '5 min', type: 'article', isCompleted: false },
          { id: 'l4', title: 'Peppermint for Digestion', duration: '4 min', type: 'video', isCompleted: false },
        ]
      }
    ]
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'l1', title: 'The Biology of Sleep', duration: '7 min', type: 'video', isCompleted: true },
          { id: 'l2', title: 'Setting a Sleep Schedule', duration: '4 min', type: 'article', isCompleted: true },
        ]
      },
      {
        id: 'm2',
        ...
        lessons: [
          { id: 'l3', title: 'Ideal Bedroom Environment', duration: '6 min', type: 'article', isCompleted: false },
          { id: 'l4', title: 'Digital Detox Strategies', duration: '5 min', type: 'video', isCompleted: false },
        ]
      }
    ]
  },
  {
    ...
    description: 'A comprehensive guide to understanding and managing blood sugar levels.',
    category: 'Medical',
    icon: 'Activity',
    progress: 0,
    totalModules: 3,
    modules: [
      {
        ...
        lessons: [
          { id: 'l1', title: 'How Insulin Works', duration: '5 min', type: 'video', isCompleted: false },
          { id: 'l2', title: 'Glucose Monitoring Tips', duration: '7 min', type: 'article', isCompleted: false },
        ]
      },
      {
        id: 'm2',
        title: 'Complications & Care',
        lessons: [
          { id: 'l3', title: 'Preventing Foot Problems', duration: '6 min', type: 'article', isCompleted: false },
          { id: 'l4', title: 'The Importance of HBA1C', duration: '4 min', type: 'video', isCompleted: false },
        ]
      }
    ]
  },
  {
    ...
    description: 'Techniques combining mindfulness, breathing, and adaptogenic herbs.',
    category: 'Lifestyle',
    icon: 'Sparkles',
    progress: 0,
    totalModules: 2,
    modules: [
      {
        ...
        lessons: [
          { id: 'l1', title: 'Box Breathing Technique', duration: '4 min', type: 'video', isCompleted: false },
          { id: 'l2', title: 'The Science of Cortisol', duration: '8 min', type: 'article', isCompleted: false },
        ]
      },
      {
        id: 'm2',
        ...
        lessons: [
          { id: 'l3', title: 'Guide to Ashwagandha', duration: '6 min', type: 'article', isCompleted: false },
          { id: 'l4', title: 'Herbal Teas for Relaxation', duration: '5 min', type: 'video', isCompleted: false },
        ]
      }
    ]
  },
  {
    id: '6',
    title: 'Digestive Health Deep-Dive',
    description: 'Restore balance to your gut microbiome with diet and natural support.',
    category: 'Medical',
    icon: 'Activity',
    progress: 0,
    totalModules: 3,
    modules: [
      {
        ...
        lessons: [
          { id: 'l1', title: 'Probiotics vs Prebiotics', duration: '6 min', type: 'article', isCompleted: false },
          { id: 'l2', title: 'Gut-Brain Axis Explained', duration: '9 min', type: 'video', isCompleted: false },
        ]
      },
      {
        id: 'm2',
        ...
        lessons: [
          { id: 'l3', title: 'Elimination Diet Guide', duration: '12 min', type: 'article', isCompleted: false },
          { id: 'l4', title: 'Bone Broth Benefits', duration: '5 min', type: 'video', isCompleted: false },
        ]
      }
    ]
  },
  {
    ...
    description: 'Strengthen your defenses through clinical evidence and herbal tradition.',
    category: 'Herbal',
    icon: 'Leaf',
    progress: 0,
    totalModules: 2,
    modules: [
      {
        ...
        title: 'Daily Habits',
        lessons: [
          { id: 'l1', title: 'Vitamin D & Immunity', duration: '5 min', type: 'video', isCompleted: false },
          { id: 'l2', title: 'The Role of Zinc', duration: '4 min', type: 'article', isCompleted: false },
        ]
      },
      {
        id: 'm2',
        title: 'Elderberry & Beyond',
        lessons: [
          { id: 'l3', title: 'Making Elderberry Syrup', duration: '8 min', type: 'video', isCompleted: false },
          { id: 'l4', title: 'Echinacea Usage Guide', duration: '6 min', type: 'article', isCompleted: false },
        ]
      }
    ]
  },
  {
    id: '8',
    title: 'Cardiovascular Fitness Basics',
    description: 'Evidence-based exercise protocols for a healthier heart.',
    category: 'Lifestyle',
    icon: 'Activity',
    progress: 0,
    totalModules: 2,
    modules: [
      {
        ...
        lessons: [
          { id: 'l1', title: 'Calculating Target Heart Rate', duration: '5 min', type: 'article', isCompleted: false },
          { id: 'l2', title: 'Low-Impact Cardio Routine', duration: '15 min', type: 'video', isCompleted: false },
        ]
      },
      {
        id: 'm2',
        title: 'Consistency',
        lessons: [
          { id: 'l3', title: 'Building a Workout Habit', duration: '7 min', type: 'article', isCompleted: false },
          { id: 'l4', title: 'Staying Safe While Active', duration: '6 min', type: 'video', isCompleted: false },
        ]
      }
    ]
  },
  {
    id: '9',
    title: 'Anti-Inflammatory Cooking',
    description: 'Practical recipes and ingredients to reduce chronic inflammation.',
    category: 'Lifestyle',
    icon: 'Sparkles',
    progress: 0,
    totalModules: 3,
    modules: [
      {
        id: 'm1',
        title: 'The Kitchen Pharmacy',
        lessons: [
          { id: 'l1', title: 'Top 10 Anti-Inflammatory Foods', duration: '8 min', type: 'article', isCompleted: false },
          { id: 'l2', title: 'Spices that Heal', duration: '6 min', type: 'video', isCompleted: false },
        ]
      },
      {
        id: 'm2',
        title: 'Meal Prep',
        lessons: [
          { id: 'l3', title: 'Batch Cooking for Beginners', duration: '10 min', type: 'video', isCompleted: false },
          { id: 'l4', title: 'Avoiding Processed Sugars', duration: '7 min', type: 'article', isCompleted: false },
        ]
      }
    ]
  },
  {
    ...
    description: 'CBT-based techniques and natural calming agents.',
    category: 'Medical',
    icon: 'Activity',
    progress: 0,
    totalModules: 2,
    modules: [
      {
        ...
        lessons: [
          { id: 'l1', title: 'Identifying Thought Distortions', duration: '10 min', type: 'article', isCompleted: false },
          { id: 'l2', title: 'Grounding Exercises 5-4-3-2-1', duration: '5 min', type: 'video', isCompleted: false },
        ]
      },
      {
        id: 'm2',
        ...
        lessons: [
          { id: 'l3', title: 'Magnesium for Anxiety', duration: '6 min', type: 'article', isCompleted: false },
          { id: 'l4', title: 'The Role of L-Theanine', duration: '4 min', type: 'video', isCompleted: false },
        ]
      }
    ]
  },
  {
    ...
    description: 'Basic medical knowledge for emergency situations at home.',
    category: 'Medical',
    icon: 'Activity',
    progress: 0,
    totalModules: 2,
    modules: [
      {
        ...
        lessons: [
          { id: 'l1', title: 'Proper Wound Cleaning', duration: '5 min', type: 'article', isCompleted: false },
          { id: 'l2', title: 'Treating First-Degree Burns', duration: '6 min', type: 'video', isCompleted: false },
        ]
      },
      {
        id: 'm2',
        title: 'Life Saving',
        lessons: [
          { id: 'l3', title: 'Heimlich Maneuver Basics', duration: '4 min', type: 'video', isCompleted: false },
          { id: 'l4', title: 'When to Call Emergency Services', duration: '3 min', type: 'article', isCompleted: false },
        ]
      }
    ]
  },
  {
    id: '12',
    title: 'Men’s Health Fundamentals',
    description: 'Understanding prostate health, testosterone, and heart disease risks.',
    category: 'Medical',
    icon: 'Activity',
    progress: 0,
    totalModules: 2,
    modules: [
      {
        id: 'm1',
        title: 'Prostate Awareness',
        lessons: [
          { id: 'l1', title: 'PSA Screening Explained', duration: '7 min', type: 'article', isCompleted: false },
          { id: 'l2', title: 'Dietary Support for the Prostate', duration: '5 min', type: 'video', isCompleted: false },
        ]
      },
      {
        id: 'm2',
        title: 'Vitality',
        lessons: [
          { id: 'l3', title: 'Boosting Natural Testosterone', duration: '8 min', type: 'article', isCompleted: false },
          { id: 'l4', title: 'Men & Cardiovascular Risk', duration: '6 min', type: 'video', isCompleted: false },
        ]
      }
    ]
  },
  {
    ...
    description: 'Navigating menstrual health, fertility, and menopause through nutrition.',
    category: 'Lifestyle',
    icon: 'Moon',
    progress: 0,
    totalModules: 3,
    modules: [
      {
        ...
        lessons: [
          { id: 'l1', title: 'Phases of the Cycle', duration: '6 min', type: 'video', isCompleted: false },
          { id: 'l2', title: 'Seed Cycling for Balance', duration: '5 min', type: 'article', isCompleted: false },
        ]
      },
      {
        id: 'm2',
        ...
        lessons: [
          { id: 'l3', title: 'Managing Hot Flashes Naturally', duration: '7 min', type: 'article', isCompleted: false },
          { id: 'l4', title: 'Bone Density in the 50s+', duration: '6 min', type: 'video', isCompleted: false },
        ]
      }
    ]
  }
