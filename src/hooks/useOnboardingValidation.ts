...
import { ValidationState, ReferralValidationState, OnboardingValidationStatus } from '@/types/onboarding';
...
export const useOnboardingValidation = (formData: OnboardingFormData) => {
  const [validationStatus, setValidationStatus] = useState<OnboardingValidationStatus>({
