...
export const FeedCard: React.FC<FeedCardProps> = ({ item, index, t }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-white dark:bg-slate-900 rounded-[40px] border border-slate-100 dark:border-slate-800 overflow-hidden hover:border-blue-500/30 transition-all duration-500 flex flex-col h-full shadow-sm hover:shadow-2xl">
        ...
        <div className="p-8 flex-1 flex flex-col">
          ...
          <h3 className="font-black text-2xl text-slate-900 dark:text-white mb-4 line-clamp-2 leading-[1.2] group-hover:text-blue-600 transition-colors tracking-tight">
            {item.title}
          </h3>
          
          <p className="text-slate-500 dark:text-slate-400 text-sm mb-8 line-clamp-3 flex-1 font-medium leading-relaxed opacity-80 group-hover:opacity-100 transition-opacity">
            {item.excerpt}
          </p>
          ...
          <div className="flex items-center justify-between pt-8 border-t border-slate-50 dark:border-slate-800/50 mt-auto">
            ...
            <div className="flex gap-2">
              <button className="p-3 text-slate-400 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-2xl transition-all active:scale-90">
