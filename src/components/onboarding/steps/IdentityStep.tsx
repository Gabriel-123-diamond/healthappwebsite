        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase text-slate-400 dark:text-slate-500 ml-1 tracking-widest">First Name</label>
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase text-slate-400 dark:text-slate-500 ml-1 tracking-widest">Last Name</label>
              <div className="relative group">
                <input 
                  type="text" 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2 text-slate-400 dark:text-slate-500">
                ...
                <span className="text-[10px] font-black uppercase tracking-widest">Date of Birth / Age Range</span>
              </div>
              <div className="flex gap-2">
                <input 
                  ...
                  className="flex-1 px-5 py-4 rounded-2xl bg-white dark:bg-slate-900 border-2 border-transparent outline-none focus:border-blue-500 transition-all font-bold text-slate-900 dark:text-white text-sm"
                />
                <div className="w-1/3">
                  <CustomSelect
