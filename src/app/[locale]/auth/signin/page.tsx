    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center py-12 pt-24 sm:pt-32 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      >
        <div className="text-center">
          ...
          <h2 className="text-4xl font-black text-slate-900 dark:text-white tracking-tighter mb-2">{t.auth.welcome}</h2>
        ...
        <div className="text-center pt-4">
          <p className="text-xs font-bold text-slate-500 dark:text-slate-400">
            ...
            <Link href="/auth/signup" className="text-blue-600 hover:text-blue-500 dark:text-blue-400 font-black uppercase tracking-widest ml-1">
              {t.auth.signUp}
            </Link>
          </p>
        </div>
