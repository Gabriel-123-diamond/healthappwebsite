                ...
                <form onSubmit={handleSubmit} className="w-full space-y-4 animate-in fade-in slide-in-from-right-8">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input 
                                                ...
                                                className="w-full bg-gray-50 border border-gray-200 rounded-2xl pl-12 pr-4 py-3 outline-none focus:border-blue-500 transition-all text-gray-900 font-semibold"
                                        ...
                                        <div className="relative">
                                            ...
                                            <input 
                                                ...
                                                className="w-full bg-gray-50 border border-gray-200 rounded-2xl pl-12 pr-12 py-3 outline-none focus:border-blue-500 transition-all text-gray-900 font-semibold"
